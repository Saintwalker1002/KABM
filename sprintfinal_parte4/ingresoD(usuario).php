...
<div class="contenedor2">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">            
            <button id="btnNuevo4" type="button" class="btn btn-success" data-toggle="modal">Nuevo</button>    
            </div>    
        </div>    
    </div>    
    <br>
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formPersonas4">    
            <div class="modal-body">
                <div class="form-group">
                <label for="nombres" class="col-form-label">Nombres:</label>
                <input type="text" class="form-control" id="nombres2">
                </div>
                <div class="form-group">
                ...
                <input type="text" class="form-control" id="rut2">
                </div>
                <div class="form-group">
                <label for="sexo" class="col-form-label">Sexo:</label>
                <input type="text" class="form-control" id="sexo2">
                </div>
                <div class="form-group">
                ...
                <input type="text" class="form-control" id="fecha_nacimiento2">
                </div>
                <div class="form-group">
                <label for="estado_civil" class="col-form-label">Estado civil:</label>
                <input type="text" class="form-control" id="estado_civil2">
                </div>
                <div class="form-group">
                <label for="comuna" class="col-form-label">Comuna:</label>
                <input type="text" class="form-control" id="comuna2">
                </div>
                <div class="form-group">
